...
{
    public partial class UpdateLector : Form
    {
        SqlConnection conn;
        public UpdateLector(SqlConnection conn)
        {
            InitializeComponent();
            this.conn = conn;
        }
        ...
        {
            string query = "SELECT  lectors.email FROM lectors";
        ...
        private void UpdateLector_Load(object sender, EventArgs e)
        {
            fillComboBox1();
        }
        ...
        {
            SqlCommand sqlCommand = new SqlCommand("SELECT * FROM lectors JOIN logins on lectors.login_id = logins.login_id WHERE lectors.email='" + comboBox1.Text.ToString() + "'", conn);
            conn.Open();
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (mobileInt == 0 && mailInt == 0 && passportInt == 0 && loginInt == 0)
                    {
                        ...
                        query.Append("exec update_lectorv1 @first_name='" + textBox1.Text.ToString() + "'" + "," +
