...
{
    public partial class DeleteTimetables : Form
    {
        SqlConnection conn;
        public DeleteTimetables(SqlConnection conn)
        {
            InitializeComponent();
            this.conn = conn;
        }
        ...
        private void DeleteTimetables_Load(object sender, EventArgs e)
        {
            fillComboBox1();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT timetable_id AS 'Идентификатор расписания', day_week AS 'День недели', date_par AS 'Дата пары', " +
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                SqlCommand sqlCommand = new SqlCommand("exec delete_timetable @group_number='" +
                    comboBox1.Text.ToString() + "'" + "," + "@lector='" +
                    comboBox2.Text.ToString() + "'" + "," + "@subject='" +
                    comboBox3.Text.ToString() + "'" + "," + "@date='" +
                    comboBox4.Text + "'" + "," +
                    "@format_par='" + comboBox6.Text.ToString() + "'" + "," +
                    "@cabinet='" + (Convert.ToInt32(comboBox7.Text)) + "'" + "," + "@housing='" + (Convert.ToInt32(comboBox8.Text)) + "'", conn);
